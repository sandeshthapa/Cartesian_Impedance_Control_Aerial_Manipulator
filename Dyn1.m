...
x_des = [0 0 4 0 0 0 .5 .5]';
x_des_dot = [0 0 0 0 0 0 0 0]';
x_des_ddt = [0 0 0 0 0 0 0 0]';
...
dxdt(9:16,1) =  -((B_x)\(fext - ((C_x + K_D)*x_telta_dot + K_P*x_telta)));
